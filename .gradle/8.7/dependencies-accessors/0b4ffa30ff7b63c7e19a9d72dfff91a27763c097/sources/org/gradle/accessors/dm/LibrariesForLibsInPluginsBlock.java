...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final GenerativeaiLibraryAccessors laccForGenerativeaiLibraryAccessors = new GenerativeaiLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>generativeai</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public GenerativeaiLibraryAccessors getGenerativeai() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForGenerativeaiLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class GenerativeaiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public GenerativeaiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        /**
         * Dependency provider for <b>v070</b> with <b>com.google.ai.client.generativeai:generativeai</b> coordinates and
         * with version reference <b>generativeaiVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV070() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("generativeai.v070");
        }
    ...
    public static class GoogleLibraryAccessors extends SubDependencyFactory {
        private final GoogleGenerativeaiLibraryAccessors laccForGoogleGenerativeaiLibraryAccessors = new GoogleGenerativeaiLibraryAccessors(owner);

        public GoogleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>google.generativeai</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public GoogleGenerativeaiLibraryAccessors getGenerativeai() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForGoogleGenerativeaiLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class GoogleGenerativeaiLibraryAccessors extends SubDependencyFactory {

        public GoogleGenerativeaiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getV070() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("google.generativeai.v070");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>generativeai</b> with value <b>0.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>generativeaiVersion</b> with value <b>1.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGenerativeaiVersion() { return getVersion("generativeaiVersion"); }
