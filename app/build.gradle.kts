...
android {
    ...
    defaultConfig {
        applicationId = "net.developermaster.appgeminiapi"
        minSdk = 21
        targetSdk = 35 //todo recordemos que la version 35 es la ultima version de android
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    //todo Google Api Generative AI Gemini
